...
import { Restaurant, duplicateRestaurants } from './data';
import AllRestaurantsSection from './RestaurantsSection';
    ...
    <footer className="bg-gray-800 text-gray-300 mt-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div><h4 className="font-bold text-white mb-3">Company</h4><ul><li className="py-1"><a href="#" className="hover:text-white">About us</a></li><li className="py-1"><a href="#" className="hover:text-white">Careers</a></li><li className="py-1"><a href="#" className="hover:text-white">Press</a></li></ul></div>
                <div><h4 className="font-bold text-white mb-3">Help</h4><ul><li className="py-1"><a href="#" className="hover:text-white">FAQs</a></li><li className="py-1"><a href="#" className="hover:text-white">Contact Us</a></li><li className="py-1"><a href="#" className="hover:text-white">Support</a></li></ul></div>
                <div><h4 className="font-bold text-white mb-3">Legal</h4><ul><li className="py-1"><a href="#" className="hover:text-white">Terms & Conditions</a></li><li className="py-1"><a href="#" className="hover:text-white">Privacy Policy</a></li></ul></div>
                <div><h4 className="font-bold text-white mb-3">Follow Us</h4><div className="flex space-x-4"><a href="#" className="hover:text-white">FB</a><a href="#" className="hover:text-white">IG</a><a href="#" className="hover:text-white">TW</a></div></div>
            </div>
            <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">&copy; {new Date().getFullYear()} foodpanda. All Rights Reserved.</div>
        </div>
    </footer>
);
