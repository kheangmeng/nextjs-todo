...
import { RotateCcwIcon, RotateCwIcon, BoldIcon, ItalicIcon, UnderlineIcon, StrikethroughIcon, TextAlignCenterIcon, TextAlignJustifyIcon, TextAlignStartIcon, TextAlignEndIcon, TextQuoteIcon, Heading1Icon, Heading2Icon, LogsIcon, ListOrderedIcon, MessageSquareQuoteIcon, CodeIcon, ChevronDownIcon, ChartNoAxesGanttIcon, LinkIcon } from 'lucide-react'
...
function positionEditorElement({editor, rect}: {editor: HTMLElement, rect: DOMRect | null}) {
  if (rect === null) {
  ...
  const updateLinkEditor = useCallback(() => {
    ...
    if (
      ...
      if (!mouseDownRef.current) {
        positionEditorElement({editor: editorElem, rect: rect || null});
      }
      setLastSelection(selection);
    } else if (!activeElement || activeElement.className !== "link-input") {
      positionEditorElement({editor: editorElem, rect: null});
      ...
      {supportedBlockTypes.has(blockType) && (
        <>
          ...
          >
            ...
            <ChartNoAxesGanttIcon className='mr-3' />
